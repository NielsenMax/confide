# Build secret-share with your OAuth client credentials baked into the binary,
...
#   CLIENT_SECRET=xxxx
#
# Then: `make` (or `make build`). Teammates just run `./secret-share login`.
...
ifndef CLIENT_ID
	...
	go build -ldflags "$(LDFLAGS)" -o secret-share .
	@echo "Built ./secret-share with embedded OAuth client $(CLIENT_ID)"
